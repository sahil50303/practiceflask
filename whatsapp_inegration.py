...
# DB credentials — move to env vars in Render

server = os.getenv("DB_SERVER", "192.168.0.108")

database = os.getenv("DB_NAME", "test_receipt")

username = os.getenv("DB_USER", "PRIII")

password = os.getenv("DB_PASSWORD", "Pri@1234")
